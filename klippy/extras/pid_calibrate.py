...
class PIDCalibrate:
    ...
    def _calibrate(
        self, pheaters, heater, target, fname, gcmd, calibrate_secondary
    ):
        if (
    ...
    def cmd_PID_CALIBRATE(self, gcmd):
        ...
        if isinstance(heater.control, heaters.ControlDualLoopPID):
            ...
            kp_s, ki_s, kd_s = self._calibrate(
                pheaters, heater, target, fname, gcmd, calibrate_secondary=True
            )
            ...
            kp_p, ki_p, kd_p = self._calibrate(
                pheaters, heater, target, fname, gcmd, calibrate_secondary=False
            )
